...
export class SelfLearningAgent {
    ...
    async updateKGRecipeLibrary(tapeOut) {
        const benchmarkBefore = this.createBenchmark(tapeOut, "before");
        const benchmarkAfter = this.createBenchmark(tapeOut, "after");
        return [{
                modelType: "kg_recipe",
    ...
    async updateSurrogateModels(tapeOut) {
        const benchmarkBefore = this.createBenchmark(tapeOut, "before");
        const benchmarkAfter = this.createBenchmark(tapeOut, "after");
        return [{
                modelType: "pinn",
    ...
    evaluateBenchmark(before, after) {
