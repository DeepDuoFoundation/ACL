import type { ReportType, ReportData, ReportSection, ChartData, TableData } from "./types.js";

export class ReportTemplates {
  getTemplate(type: ReportType): ReportSection[] {
    switch (type) {
      case "job_summary":
  ...
  private jobSummaryTemplate(): ReportSection[] {
    return [
  ...
  private tapeoutReadinessTemplate(): ReportSection[] {
    return [
  ...
  private runComparisonTemplate(): ReportSection[] {
    return [
  ...
  private yieldPredictionTemplate(): ReportSection[] {
    return [
  ...
  private rcaInvestigationTemplate(): ReportSection[] {
    return [
  ...
  private teamProgressTemplate(): ReportSection[] {
    return [
  ...
  private customerDeliverableTemplate(): ReportSection[] {
    return [
