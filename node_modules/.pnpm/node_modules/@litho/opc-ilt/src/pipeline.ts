...
export class OPcILTPipeline {
  ...
  private ruleBased: RuleBasedOPC;
  private ilt: ILTSynthesis;
  private fdtd: FDTDSimulator;
  private pinn: PINNSimulator;
  ...
  async run(mask: MaskPattern): Promise<{
    opcResult: OPCResult;
    iltResult: ILTResult;
  ...
  private async runILTFallback(mask: MaskPattern): Promise<OPCResult> {
