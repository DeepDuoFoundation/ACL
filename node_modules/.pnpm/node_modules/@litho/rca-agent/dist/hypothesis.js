export class HypothesisGenerator {
    ...
    async generate(symptom, kgEvidence) {
        const hypotheses = [];
    ...
    generateLayoutHypotheses(symptom, evidence) {
        const hypotheses = [];
    ...
    generateMaskHypotheses(symptom, evidence) {
        const hypotheses = [];
    ...
    generateIlluminationHypotheses(symptom, evidence) {
        const hypotheses = [];
        if (symptom.type === "epe_violation") {
            hypotheses.push({
    ...
    generateResistHypotheses(symptom, evidence) {
        const hypotheses = [];
        if (symptom.type === "cd_variation") {
            hypotheses.push({
    ...
    generateEquipmentHypotheses(symptom, evidence) {
        const hypotheses = [];
