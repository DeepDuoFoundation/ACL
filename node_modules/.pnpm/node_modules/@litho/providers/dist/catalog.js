export const PROVIDERS = {
    ...
    "anthropic": {
        ...
        compat: "anthropic-oc", category: "cloud",
    },
    "openai": {
        id: "openai", label: "OpenAI",
        baseURL: "https://api.openai.com/v1", apiKeyEnv: "OPENAI_API_KEY",
        compat: "openai", category: "cloud", discovery: "openai-models",
    },
    "azure": {
        id: "azure", label: "Azure OpenAI",
        baseURL: "https://YOUR-RESOURCE.openai.azure.com/openai",
        apiKeyEnv: "AZURE_OPENAI_API_KEY", compat: "azure", category: "cloud",
    },
    "google": {
        id: "google", label: "Google Gemini",
        baseURL: "https://generativelanguage.googleapis.com/v1beta/openai",
        apiKeyEnv: "GEMINI_API_KEY", compat: "anthropic-oc", category: "cloud",
    },
    "vertex": {
        id: "vertex", label: "Google Vertex AI",
        baseURL: "https://us-central1-aiplatform.googleapis.com/v1beta1",
        apiKeyEnv: "GOOGLE_VERTEX_API_KEY", compat: "proxy", category: "cloud",
    },
    "bedrock": {
        id: "bedrock", label: "AWS Bedrock",
        baseURL: "https://bedrock-runtime.us-east-1.amazonaws.com",
        apiKeyEnv: "AWS_BEDROCK_API_KEY", compat: "proxy", category: "cloud",
    },
    "xai": {
        id: "xai", label: "xAI (Grok)",
        baseURL: "https://api.x.ai/v1", apiKeyEnv: "XAI_API_KEY",
        compat: "openai", category: "cloud",
    },
    "mistral": {
    ...
    "groq": {
        id: "groq", label: "Groq",
        apiKeyEnv: "GROQ_API_KEY", compat: "openai", category: "api",
    },
    "deepseek": {
        id: "deepseek", label: "DeepSeek",
        apiKeyEnv: "DEEPSEEK_API_KEY", compat: "openai", category: "api",
    },
    "moonshot": {
        id: "moonshot", label: "Moonshot AI (Kimi)",
        apiKeyEnv: "MOONSHOT_API_KEY", compat: "openai", category: "api",
    },
    "qwen": {
        id: "qwen", label: "Alibaba Qwen",
        apiKeyEnv: "DASHSCOPE_API_KEY", compat: "openai", category: "api",
    },
    "fireworks": {
        id: "fireworks", label: "Fireworks",
        apiKeyEnv: "FIREWORKS_API_KEY", compat: "openai", category: "api",
    },
    "cerebras": {
        id: "cerebras", label: "Cerebras",
        apiKeyEnv: "CEREBRAS_API_KEY", compat: "openai", category: "api",
    },
    "sambanova": {
        id: "sambanova", label: "SambaNova",
        apiKeyEnv: "SAMBANOVA_API_KEY", compat: "openai", category: "api",
    },
    "deepinfra": {
        id: "deepinfra", label: "DeepInfra",
        apiKeyEnv: "DEEPINFRA_API_KEY", compat: "openai", category: "api",
    },
    "featherless": {
        id: "featherless", label: "Featherless",
        apiKeyEnv: "FEATHERLESS_API_KEY", compat: "openai", category: "api",
    },
    "together": {
        id: "together", label: "Together AI",
        apiKeyEnv: "TOGETHER_API_KEY", compat: "openai", category: "api",
    },
    "venice": {
        id: "venice", label: "Venice AI",
        apiKeyEnv: "VENICE_API_KEY", compat: "openai", category: "api",
    },
    "snowflake-cortex": {
        id: "snowflake-cortex", label: "Snowflake Cortex",
        apiKeyEnv: "SNOWFLAKE_CORTEX_TOKEN", compat: "openai", category: "api",
    },
    "huggingface": {
        id: "huggingface", label: "HuggingFace",
        apiKeyEnv: "HF_API_KEY", compat: "openai", category: "api", discovery: "env-models",
    },
    "litellm": {
        id: "litellm", label: "LiteLLM Proxy",
        apiKeyEnv: "LITELLM_API_KEY", compat: "openai", category: "api",
    },
    "chutes": {
        id: "chutes", label: "Chutes",
        apiKeyEnv: "CHUTES_API_KEY", compat: "openai", category: "api",
    },
    "zai": {
        id: "zai", label: "Z.AI (GLM)",
        apiKeyEnv: "ZAI_API_KEY", compat: "openai", category: "api",
    },
    "doubao": {
        id: "doubao", label: "Volcengine Doubao",
        apiKeyEnv: "DOUBAO_API_KEY", compat: "openai", category: "api",
    },
    "io-intelligence": {
        id: "io-intelligence", label: "IO Intelligence",
        apiKeyEnv: "IO_INTELLIGENCE_API_KEY", compat: "openai", category: "api",
    },
    "minimax": {
        id: "minimax", label: "MiniMax",
        apiKeyEnv: "MINIMAX_API_KEY", compat: "openai", category: "api",
    },
    "roo": {
        id: "roo", label: "Roo Code Gateway",
        apiKeyEnv: "ROO_API_KEY", compat: "openai", category: "api",
    },
    // ── Local / Self-Hosted (4) ──
    "ollama": {
        id: "ollama", label: "Ollama (local)",
        baseURL: "http://localhost:11434/v1", apiKeyEnv: "",
        compat: "openai", category: "local",
    },
    "lmstudio": {
